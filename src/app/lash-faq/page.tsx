        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <div className="bg-gold/10 border border-gold/30 rounded-2xl p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://app.glossgenius.com" target="_blank" rel="noopener noreferrer" className="font-sans text-sm font-medium bg-gold text-espresso px-5 py-2.5 rounded-full hover:bg-gold/90 transition-colors">
                Book Now
              </a>
            </div>
          </div>
