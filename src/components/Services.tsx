    ...
    <section id="services" className="bg-cream py-24 lg:py-32 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <p className="font-sans text-gold text-xs tracking-[0.2em] uppercase mb-4">Our Services</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            ...
            >
              {service.gold && (
                <span className="inline-block font-sans text-xs text-gold tracking-widest uppercase mb-4">Featured</span>
              )}
              ...
              <Link
                ...
                className={`font-sans text-sm font-medium transition-colors ${
                  service.gold ? "text-gold hover:text-espresso" : "text-espresso/40 group-hover:text-gold"
                }`}
              >
                View Pricing →
              </Link>
